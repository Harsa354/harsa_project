    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-middle">
                <button type="submit"  class="btn mt-3 btn-success btn-rounded p-0 btn-icon-only text-secondary font-weight-bold text-xs" data-bs-toggle="modal" data-bs-target="#exampleModal" data-mode="edit" data-id="{{ $jenis->id }}" data-nama_jenis="{{ $jenis->nama_jenis }}" data-kategori_id="{{ $jenis->kategori_id }}">
